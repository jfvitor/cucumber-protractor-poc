...
exports.handler = function (argv) {
    return logger_1.adjustLogging(argv.log)
        ...
        .then(process_1.executeWith(flatten(['-jar', cliJarIn(argv.cacheDir), argumentsFrom(argv)])))
        .catch(logging_1.complain('%s'))
        .then(logging_1.inform('All done!'));
};
// --
exports.javaFor = function (os) { return (os === 'Windows_NT') ? 'java.exe' : 'java'; };
...
var cliJarIn = function (cacheDir) { return path.resolve(cacheDir, files_1.filenameOf(config_1.defaults.artifact)); };
...
var flatten = function (list) { return list.reduce(function (acc, current) { return (Array.isArray(current)
