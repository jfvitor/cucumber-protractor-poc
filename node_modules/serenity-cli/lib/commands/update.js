...
exports.handler = function (argv) {
    return logger_1.adjustLogging(argv.log)
        ...
        .then(downloadArtifactIfNeeded(config_1.defaults.artifact, argv.repository, argv.ignoreSSL))
        .catch(logging_1.complain('%s'));
};
// --
var downloadArtifactIfNeeded = function (artifact, repository, ignoreSSL) { return function (cacheDir) {
    ...
    return files_1.checkIfFileMissing(pathToCached)
        ...
        .then(flow_control_1.conditionally(function () { return download_1.download(artifact, cacheDir, ignoreSSL, repository); }))
